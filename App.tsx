          ...
          <div className="pt-12 border-t border-slate-300/50">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-slate-500">
              <div className="flex items-center gap-5 text-left">
                <div className="w-14 h-14 military-gradient rounded-2xl flex items-center justify-center text-yellow-400 shadow-xl ring-4 ring-white">
                  <Star fill="currentColor" size={30} />
                </div>
                <div>
                  <p className="font-black text-slate-900 uppercase tracking-widest leading-none mb-1">
                    Bộ tư lệnh Thành phố Hồ Chí Minh
                  </p>
